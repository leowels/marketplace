...
SECRET_KEY = "django-insecure-q#v*=*+@my)2zj8wn29o%oje$x-ljwkosza34p#^+3@iw_ojzh"
...
INSTALLED_APPS = [
    ...
    'marketplace_app',  # Новое приложение
]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # Указываем MySQL как движок базы данных
        'NAME': 'marketplace',             # Имя вашей базы данных
        'USER': 'root',              # Имя пользователя базы данных
        'PASSWORD': 'qwerty',          # Пароль к базе данных
